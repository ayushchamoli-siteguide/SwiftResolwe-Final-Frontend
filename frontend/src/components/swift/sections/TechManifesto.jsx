      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8">
        <Reveal className="rounded-3xl border border-[color:var(--border-soft)] bg-white relative overflow-hidden p-10 md:p-14">
          ...
          <div className="relative">
            ...
            <p className="mt-6 text-[16.5px] leading-[1.75] text-[color:var(--text-secondary)] max-w-3xl">
              We use AI to organize filings, summarize complex document stacks, and route cases
              dynamically, never to decide them. All adjudicatory decisions stay strictly human.
              AI operates within strict access controls and end to end encryption, so case data
              stays private and is never used to determine an outcome.
            </p>
          </div>
        </Reveal>
      </div>
